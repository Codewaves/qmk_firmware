...
[_LOWER] = LAYOUT(\
    _______, KC_LGUI, KC_PGUP, KC_UP,   KC_PGDN, KC_INS,       KC_MINS, KC_7,    KC_8,    KC_9,    KC_PAST, _______, \
    _______, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,       KC_EQL,  KC_4,    KC_5,    KC_6,    KC_PSLS, _______, \
    _______, KC_NLCK, CL_CUT,  CL_COPY, CL_PSTE, KC_CAPS,      KC_PPLS, KC_1,    KC_2,    KC_3,    KC_DOT,  _______, \
                               _______, _______, _______,      _______, _______, KC_0\
),

[_RAISE] = LAYOUT(\
    _______, _______, KC_CIRC, KC_EXLM, KC_DQUO, KC_QUOT,      KC_ASTR, KC_LBRC, KC_AMPR, KC_RBRC, _______, _______, \
    _______, _______, KC_LABK, KC_PERC, KC_RABK, KC_TILD,      KC_QUES, KC_LPRN, KC_DLR,  KC_RPRN, KC_BSLS, _______, \
    _______, _______, _______, KC_AT,   KC_UNDS, KC_GRV,       KC_PIPE, KC_LCBR, KC_HASH, KC_RCBR, _______, _______, \
